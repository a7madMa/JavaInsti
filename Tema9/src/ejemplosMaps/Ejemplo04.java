...
public class Ejemplo04 {
	...
	public static void main(String[] args) {
		...
		// Hemos añadido unos métodos equals() y hasCode() a la clase Cliente para poder
		// usarla como clave.
		...
		Ficha ficha2 = new Ficha(1999, "Italia", "0000-1111-2222-3333");
		Ficha ficha3 = new Ficha(2000, "España", "3000-1000-2000-5000");
